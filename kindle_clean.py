...
BadChecker = CheckBlackWords("./unikeyword.txt")
...
def step1(text):
    ...
    #    return "cn-kindle_IsChatperText",0,cleaned_content
    ...
    #cleaned_content = SpecialPolicies.RemoveSpamFromContent(cleaned_content,spam=r"(图片发自简书app|原文地址:|综合网络,如有侵权联系删除。)")
...
def step2(text):
    #is_sentive = BadChecker.is_spam_text(text)
    #if is_sentive:
