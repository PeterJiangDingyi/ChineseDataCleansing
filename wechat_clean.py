...
from util import load_list_from_structedTxt,load_set_from_txt
from check_black_words import CheckBlackWords
...
WeChatCleaner = CleanHeadTailsFromContent("./wechat_ads_phrase.txt")
...
def make_clean(items):
    ...
    with open(fpath,"r",encoding="utf-8") as f:
        ...
        for line_no,line in tqdm(enumerate(datas),total=len(datas)):
            ...
            js_dict["id"] = line_no + 1
            js_dict["source"] = "cn-wechat"
            js_dict["subset"] = "gong_zhong_hao"
